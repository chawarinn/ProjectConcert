...
class SendOTPA extends StatefulWidget {
  int userId;
  SendOTPA({super.key, required this.userId});

  @override
  _SendOTPAState createState() => _SendOTPAState();
}

class _SendOTPAState extends State<SendOTPA> {
  bool isLoading = true;
