...
class EditPasswordA extends StatefulWidget {
  final int userId;
  EditPasswordA({super.key, required this.userId});

  @override
  _EditPasswordAState createState() => _EditPasswordAState();
}

class _EditPasswordAState extends State<EditPasswordA> {
              ...
              TextButton(
                onPressed: () {
                  Navigator.pushReplacement(
                    context,
                    MaterialPageRoute(
                      builder: (context) => ProfileAdmin(userId: widget.userId),
                    ),
                  );
                },
