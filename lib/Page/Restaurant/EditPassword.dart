...
class EditPasswordRes extends StatefulWidget {
  final int userId;
  EditPasswordRes({super.key, required this.userId});

  @override
  _EditPasswordResState createState() => _EditPasswordResState();
}

class _EditPasswordResState extends State<EditPasswordRes> {
